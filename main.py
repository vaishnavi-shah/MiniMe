...
def speak(audio):
    engine.say(audio)
    output_text.insert(tk.END, f"Minime: {audio}\n")
    engine.runAndWait()
...
def takeCommand():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            output_text.insert(tk.END, f"User said: {recognized_text}\n")
        except sr.WaitTimeoutError:
            output_text.insert(tk.END, "Listening timed out while waiting for phrase to start.\n")
...
root = tk.Tk()
root.title("Minime Virtual Assistant")
